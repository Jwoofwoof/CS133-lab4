...
# 48 "/home/centos/CS133-lab4/lab4/lib/cnn-krnl.h"
...
inline void read_weight_from_memory(
  ...
  for (int i = 0; i < (256); i++)
    for (int j = 0; j < (256); j++)
      for (int k = 0; k < (5); k++)
        for (int l = 0; l < (5); l++)
          weight[i][j][k][l] = (weight_g[(i)*(256)*(5)*(5)+(j)*(5)*(5)+(k)*(5)+(l)]);
}
...
inline void read_input_from_memory(int hh, int ww,
  ...
  read_input:
  for (int j = 0; j < (256); j++)
    for (int h = 0; h < (112) + 4; h++)
      for (int w = 0; w < (112) + 4; w++)
        input[j][h][w] = (input_g[(j)*(228)*(228)+(hh + h)*(228)+(ww + w)]);
}
...
inline void write_output_to_memory(int hh, int ww,
  ...
  for (int i = 0; i < (256); i++)
    for (int h = 0; h < (112)/2; h++)
      for (int w = 0; w < (112)/2; w++)
        (output_g[(i)*(112)*(112)+(hh/2 + h)*(112)+ww/2 + w]) = output[i][h][w];
}
# 238 "/home/centos/CS133-lab4/lab4/lib/cnn-krnl.h"
