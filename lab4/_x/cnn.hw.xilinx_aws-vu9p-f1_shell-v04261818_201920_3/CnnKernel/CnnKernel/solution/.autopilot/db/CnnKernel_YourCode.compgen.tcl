...
set name CnnKernel_urem_7ns_4ns_3_11_seq_1
...
set id 209
set name CnnKernel_mul_mul_9ns_16ns_24_4_1
...
set ce_signed 0
set out_width 24
set arg_lists {i0 {9 0 +} i1 {16 0 +} p {24 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
...
set id 210
set name CnnKernel_ama_addmuladd_7ns_8ns_8ns_8ns_16_4_1
...
set ce_signed 0
set out_width 16
set arg_lists {i0 {7 0 +} i1 {8 0 +} s {8 0 +} i2 {8 0 +} m {16 1 +} i3 {8 0 +} p {16 0 +} c_expval {c} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {dsp} LATENCY 3 ALLOW_PRAGMA 1
}
...
set id 211
set name CnnKernel_mul_mul_16s_5ns_18_4_1
set corename simcore_mul
set op mul
set stage_num 4
set clk_width 1
...
set ce_signed 0
set out_width 18
set arg_lists {i0 {16 1 +} i1 {5 0 +} p {18 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {dsp} LATENCY 3 ALLOW_PRAGMA 1
}
...
set id 213
set name CnnKernel_mul_mul_9ns_14ns_22_4_1
set corename simcore_mul
set op mul
set stage_num 4
set clk_width 1
...
set ce_signed 0
set out_width 22
set arg_lists {i0 {9 0 +} i1 {14 0 +} p {22 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {dsp} LATENCY 3 ALLOW_PRAGMA 1
}
...
set ID 221
set hasByteEnable 0
set MemName CnnKernel_CnnKernel_YourCode_weight_V_0_0
...
set ID 222
set hasByteEnable 0
set MemName CnnKernel_CnnKernel_YourCode_input_V_0_0
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 8
set AddrRange 147456
set AddrWd 18
set impl_style auto
set TrueReset 0
set IsROM 0
...
set ID 223
set hasByteEnable 0
set MemName CnnKernel_CnnKernel_YourCode_input_V_0_1
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 8
set AddrRange 141312
set AddrWd 18
set impl_style auto
set TrueReset 0
set IsROM 0
...
set ID 224
set hasByteEnable 0
set MemName CnnKernel_CnnKernel_YourCode_input_V_1_1
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 8
set AddrRange 135424
set AddrWd 18
set impl_style auto
set TrueReset 0
set IsROM 0
...
set ID 225
set hasByteEnable 0
set MemName CnnKernel_CnnKernel_YourCode_C_V
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 17
set AddrRange 12544
...
set ID 226
set hasByteEnable 0
set MemName CnnKernel_CnnKernel_YourCode_output_V
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 8
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_weight_g \
    op interface \
    ports { weight_g { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_output_g \
    op interface \
    ports { output_g { I 64 vector } } \
} "
}
