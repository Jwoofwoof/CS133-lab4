set moduleName CnnKernel_YourCode_Pipeline_set_bias_VITIS_LOOP_52_1
set isTopModule 0
...
set C_modelName {CnnKernel_YourCode_Pipeline_set_bias_VITIS_LOOP_52_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ C_V int 17 regular {array 12544 { 0 3 } 0 1 } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "C_V", "interface" : "memory", "bitwidth" : 17, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ C_V_address0 sc_out sc_lv 14 signal 0 } 
	{ C_V_ce0 sc_out sc_logic 1 signal 0 } 
	{ C_V_we0 sc_out sc_logic 1 signal 0 } 
	{ C_V_d0 sc_out sc_lv 17 signal 0 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	C_V { ap_memory {  { C_V_address0 mem_address 1 14 }  { C_V_ce0 mem_ce 1 1 }  { C_V_we0 mem_we 1 1 }  { C_V_d0 mem_din 1 17 } } }
}
