set moduleName CnnKernel_YourCode_Pipeline_maxpool_VITIS_LOOP_84_7
set isTopModule 0
...
set C_modelName {CnnKernel_YourCode_Pipeline_maxpool_VITIS_LOOP_84_7}
set C_modelType { void 0 }
set C_modelArgList {
	{ sub_ln85 int 16 regular  }
	{ C_V int 17 regular {array 12544 { 1 1 } 1 1 } {global 0}  }
	{ output_V int 8 regular {array 802816 { 0 3 } 0 1 } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "sub_ln85", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "C_V", "interface" : "memory", "bitwidth" : 17, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "output_V", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sub_ln85", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "sub_ln85", "role": "default" }} , 
 	...
 	{ "name": "C_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "C_V", "role": "q0" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "6276", "Max" : "6276"}
	, {"Name" : "Interval", "Min" : "6276", "Max" : "6276"}
]}
...
set Spec2ImplPortList { 
	sub_ln85 { ap_none {  { sub_ln85 in_data 0 16 } } }
	C_V { ap_memory {  { C_V_address0 mem_address 1 14 }  { C_V_ce0 mem_ce 1 1 }  { C_V_q0 mem_dout 0 17 }  { C_V_address1 MemPortADDR2 1 14 }  { C_V_ce1 MemPortCE2 1 1 }  { C_V_q1 MemPortDOUT2 0 17 } } }
	output_V { ap_memory {  { output_V_address0 mem_address 1 20 }  { output_V_ce0 mem_ce 1 1 }  { output_V_we0 mem_we 1 1 }  { output_V_d0 mem_din 1 8 } } }
}
